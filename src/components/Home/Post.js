...
import {Text, View, CameraRoll, ImageEditor,StyleSheet, Image, TouchableOpacity,TextInput, Platform} from 'react-native';
            ...
            if(status === "granted"){
                ImagePicker.launchImageLibraryAsync({
                    ...
                    ImageEditor.cropImage(
                        ...
                        e=> console.log("error occoured", e)
                    );
                });
            }
        }
